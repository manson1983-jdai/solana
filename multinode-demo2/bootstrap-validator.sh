...
identity=$SOLANA_CONFIG_DIR/validator-1/identity.json
vote_account="$SOLANA_CONFIG_DIR"/validator-1/vote-account.json

ledger_dir="$SOLANA_CONFIG_DIR"/validator-1
[[ -d "$ledger_dir" ]] || {
